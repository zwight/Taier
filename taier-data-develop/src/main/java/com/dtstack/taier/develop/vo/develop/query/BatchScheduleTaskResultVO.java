...
@ApiModel("调度任务信息")
public class BatchScheduleTaskResultVO {
    ...
    public List<BatchScheduleTaskResultVO> getTaskRuleList() {
        return taskRuleList;
    }

    public void setTaskRuleList(List<BatchScheduleTaskResultVO> taskRuleList) {
