...
import com.dtstack.taier.develop.vo.develop.result.BatchUserResultVO;
...
public class BatchScheduleTaskVO {
    ...
    public void setCreateUser(BatchUserResultVO createUser) {
        this.createUser = createUser;
    }

    public BatchUserResultVO getModifyUser() {
        return modifyUser;
    }
    ...
    public BatchScheduleTaskVO getSubNodes() {
        return subNodes;
    }

    public void setSubNodes(BatchScheduleTaskVO subNodes) {
        this.subNodes = subNodes;
    }

    public List<BatchScheduleTaskVO> getRelatedTasks() {
        return relatedTasks;
    }

    public void setRelatedTasks(List<BatchScheduleTaskVO> relatedTasks) {
    ...
    public void setSubTaskVOS(List<BatchScheduleTaskVO> subTaskVOS) {
